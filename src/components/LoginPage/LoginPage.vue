  ...
  <div class="tw-w-screen tw-h-screen main-background tw-select-none tw-overflow-hidden">
    ...
    <div ref="content" class="tw-flex tw-flex-col tw-w-full tw-h-full">
      ...
      <div ref="middle" class="tw-w-full tw-h-20 tw-flex-grow tw-flex  tw-flex-col tw-justify-center tw-items-center  tw-z-10" style="min-height:300px">
        <div class="tw-w-72 tw-h-40 tw-rounded-xl tw-flex tw-flex-col tw-flex-nowrap" style="background-color:rgba(249,153,183,0.8)" v-if="show_middle">
        ...
        <button class="tw-rounded-full tw-w-12 tw-h-12 tw-mt-2 tw-bg-blue-400 tw-flex tw-items-center tw-justify-center hover:tw-bg-blue-500 tw-outline-none animate__animated" v-if="show_middle" @click="login_clicked" :class="{'animate__shakeX':button_shaking}">
...
<style scoped>
.main-background{
  background-image: linear-gradient(to bottom right, rgba(252,107,156), rgba(252,107,156));
  color:white
}
